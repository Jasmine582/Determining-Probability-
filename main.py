...
# print(f"The average fare of those who do not survived was: ${round(np.mean(fare_not_survived), 2)}")
# print(f"The median fare of those who survived was: ${round(np.median(fare_survived), 2)}")
# print(f"The median fare of those who do not survived was: ${round(np.median(fare_not_survived), 2)}")
...
plt.xlabel("Fare Data")
plt.ylabel("Passenger Data")
plt.title("Titanic Fares and Survival Rates")
plt.gca().legend(("Did Not Survive","Survived"))
plt.savefig("probability_survivors.png")